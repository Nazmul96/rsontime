...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2022 at 11:26 AM
...
--
-- Dumping data for table `constant_contact`
--

INSERT INTO `constant_contact` (`id`, `api_key`, `secret_key`, `access_token`, `refresh_token`, `expired_time`) VALUES
(21, '37b8cdd4-431b-48b0-adc2-cca90eca661a', 'qHH-I5LMSCg37s1rO5ut8w', 'f9yTihvrpTaw0yxeoPFquXXrWTCs', 'VwIeyPGli55javyI8Vmq1W2ZqkmFwSN2YUdnS2FXQi', '1643635323');

-- --------------------------------------------------------

--
-- Table structure for table `get_response`
--
...
--
-- Dumping data for table `get_response`
--

INSERT INTO `get_response` (`id`, `api_key`, `campaign_id`) VALUES
(1, 'a1qy2w4xw4cyy4cloboxcsr0hma9v1gl', NULL);
...
INSERT INTO `mailchimp` (`id`, `api_key`, `list_id`) VALUES
(28, '', 'zpen9');

-- --------------------------------------------------------

--
-- Table structure for table `moosend`
--

CREATE TABLE `moosend` (
  `id` int(10) NOT NULL,
  `api_key` varchar(80) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `moosend`
--

INSERT INTO `moosend` (`id`, `api_key`) VALUES
(1, 'f2ef6313-8cea-4e2c-a933-1be9d708a356');
...
(38, 'Counter_settings', 'new_theme', 'New Theme', 'theme3'),
...
(65, 'Seo_setting', 'robots_name', 'robots name', 'robots'),
(66, 'Seo_setting', 'robots_content', 'robots content', 'noindex');
...
(35, 'nazmul@sahajjo.com', '2022-01-20', '02:23'),
(36, 'nazmul@sahajjo1.com', '2022-01-20', '04:01'),
(37, 'nazmul@sahajjo134.com', '2022-01-23', '11:33'),
(38, 'nazmulnew@sahajjo.com', '2022-02-01', '07:57'),
(39, 'nazmulhasan@sahajjo.com', '2022-02-02', '11:27');
...
INSERT INTO `visitors` (`id`, `server_ip`, `browser`, `date`, `time`) VALUES
(9, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-01-18', 1642484990),
(11, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-01-19', 1642568265),
(12, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-01-20', 1642661991),
(13, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2021-12-20', 1642661991),
(14, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-01-21', 1642661991),
(15, '127.0.01', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-02-21', 1642661991),
(16, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.71 Safari/537.36', '2022-01-22', 1642825616),
(17, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-01-22', 1642851375),
(18, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-01-23', 1642912513),
(19, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-01-24', 1642999001),
(20, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-01-30', 1643519343),
(21, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-02-01', 1643692424),
(22, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.99 Safari/537.36', '2022-02-02', 1643776444);
...
--
-- Indexes for table `constant_contact`
--
ALTER TABLE `constant_contact`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `get_response`
--
ALTER TABLE `get_response`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `constant_contact`
--
ALTER TABLE `constant_contact`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `get_response`
--
ALTER TABLE `get_response`
...
--
-- AUTO_INCREMENT for table `moosend`
--
ALTER TABLE `moosend`
