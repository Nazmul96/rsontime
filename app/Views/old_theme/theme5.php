...
<link href="https://fonts.googleapis.com/css2?family=Monoton&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/frontend/assets/css/theme6.css">
    ...
    <script src="<?php echo base_url();?>/frontend/assets/js/jquery-3.3.1.min.js"></script>
     <script type="text/javascript" src="<?php echo base_url();?>/frontend/assets/js/jquery.particleground.min.js"></script>
...
<?php } else {?>
  ...
  <?php } ?>
    ...
    <?php if($Custom_theme_settings[4]->settings_value == 'yes'){?>
      ...
      <?php } ?> 
     <?php }else {?> 
    <div class="bg" style="background: url(<?php echo base_url();?>/frontend/assets/img/bg/b4.jpg);">  </div>
     <div class="patter_bg" style="background:#fff">  </div>
     <?php } ?>
    ...
    <div class=" theme6_content">
        <div class="home_content   model active">
          <div class="theme6_content_area">
               <div id="timer">
        <div id="days"></div>
   ...
   <div class="subscription_contant_area model">
        <div class="subscription_contant">
            ...
            <span id="mgs_success" style="color:red;"></span> 
            <span class="close_model"><i class="lar la-times-circle"></i></span>
        </div>
    </div>
  <div class="conatct_us model">
    ...
    <script src="<?php echo base_url();?>/frontend/assets/js/theme6.js"></script>
...
// jQuery plugin example:*/ 
 $('.subscription_button').click(function(){
    $('.subscription_contant_area').show('slow');
    $('.subscription_contant_area').addClass('active');
       $('.close_model').show();
})
    ...
    .home_content p{
     ...
     .social_list a {
      ...
      <?php if($Custom_theme_settings[18]->settings_value){?>
       background:<?php echo $Custom_theme_settings[8]->settings_value?>;   
      <?Php }?>
