...
<?php } else {?>
  ...
  <?php if($General_setting[4]->settings_value == 'yes'){?>
    ...
    <a href="javascript:;" class="contactus conatct_us_button"> <i class="las la-phone-volume"></i> <span> CONTACT US </span></a>
  ...
  <div class="content_details">
      ...
      <div class="row" style="margin-top:5px;">
        ...
        <?php if($Contact_us_details[13]->settings_value=='yes') {?> 
          ...
          <!-- Google map show -->
          <div class="ml-4" id="map" style="width:100%;height:400px;">
      ...
      <form action="<?php echo base_url();?>/" method="post" class="subscribe_submit">
         <input type="hidden" name="subscribe" value="subscribe">
          ...
          <button type="submit">
		   ...
		   <p id="mgs" class="text-danger mt-2"></p>
          <p id="mgs_success"class="text-success mt-2"></p> 
          <small style="color:red;" class="text-danger">
          <?php if (isset($validation)) {
