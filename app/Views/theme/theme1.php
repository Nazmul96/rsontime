...
<?php } else {?>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/frontend/assets/css/theme2.css">
...
<?php } else {?>
  ...
  <?php } ?>
    ...
    <input type="hidden" name="" id="days_time" value="<?php echo $days?>"> 
    <?php if($Custom_theme_settings[4]->settings_value == 'yes'){?>
      ...
      <?php } ?>  
    <?php } else {?> 
      <div class="bg" style="background: url(<?php echo base_url();?>/frontend/assets/img/bg/b1.jpg);">  </div>
      <div class="patter_bg" style="background: url(<?php echo base_url();?>/frontend/assets/img/pattern/pattern_1.png);">  </div>   
    <?php } ?>  
    <div class="theme2_content">
        <div class="theme2_content_area">
            <div id="countdown-gampang"></div>
            <br>
            <?php if($General_setting[1]->settings_value == 'yes'){?>
              <h2><?php echo $Counter_settings[3]->settings_value;?></h2>
              <?php } ?>
  ...
  <div class="conatct_us model">
    ...
    <script src="<?php echo base_url();?>/frontend/assets/js/jquery.countdowngampang.js"></script>
   ...
   //------------------------------------
        ...
        $('.conatct_us_button').on('click',function(){
           ...
           var jodu=parseInt($('#days_time').val());

            var element = $('#countdown-gampang');
            var finish_d = new Date();
            finish_d.setDate(finish_d.getDate() + jodu);
               ...
               $.ajax({
                    ...
                    success: function(data) {
                      ...
                      for (i = 0; i < data.length; i++) {
                        ...
                        html+='<a href="<?php echo base_url();?>/image/gallery_image/'+data[i].images+'" data-lightbox="image-1" data-title="Work 1"><img src="<?php echo base_url();?>/image/gallery_image/thumbnail/thum_'+data[i].images+'"></a>';
